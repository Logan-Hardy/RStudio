---
title: "Report.1 In Class Starter (RMD Tricks)"
author: "Your Name"
...
Run the code below and look at the knitted version. Then add dpi= 250, fig.width=7, fig.height=7 to the code chunk header and knit again. Adding fig.cap with add a caption and fig.align can be changed to 'center', 'left' or 'right'

```{r, dpi=250, fig.width=7, fig.height=7, fig = "figure 1 shows...", fig.align='right'}
diamonds %>% 
...
The mean of the price variable is ___`r mean(diamonds$price, na.rm = TRUE)`.
