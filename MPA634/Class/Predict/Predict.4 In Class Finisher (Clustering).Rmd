---
title: "Predict.4 In Class Finisher (Clustering)"
author: "Your Name"
date: "3/12/2022"
...
A: There aren't any obvious clusters, but there are some variables that look like they have some groupings.

# K-means clustering 
Not to be confused with kNN which we used to impute data, K-means is a clustering method. It requires us to first figure out the optimum number of clusters. Run the code below and look at the sum of squares graph. 
```{r}
...
A: There are some variables that are very mixed, but it did seem to identify some groupings in other columns. 
...
A: It depends on our random sample, but we need to compare the top two numbers.
