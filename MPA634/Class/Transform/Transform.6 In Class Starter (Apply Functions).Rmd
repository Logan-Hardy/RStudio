---
title: "Transform.6 In Class Starter (Apply Functions)"
...
MARGIN=1 Rows 
MARGIN=2 Columns 
MARGIN=c(1,2) for specific cells 
...
Q: What type of object does this apply function output? 
A: 
...
object <- apply(mtcars, MARGIN=c(1,2), function(x) round(x, digits = 1))
...
apply(mpg, 2, title_round) %>% as.tibble()
...
logica <- map_lgl(mpg, is.character)

lapply(mpg[logica], unique)
sapply(mpg[logica], unique)
```
